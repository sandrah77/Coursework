...
public class Ex02_1_classicsFactorial {
	...
	public static void main (String [] args) {
		...
		Ex02_1_classicsFactorial t = new Ex02_1_classicsFactorial();
		int number = input.nextInt();

		//t.factorialIterative(number);
		System.out.println ("The fact. value is: " + t.factorialRec(number));
	}
////////////////////////////////////////
